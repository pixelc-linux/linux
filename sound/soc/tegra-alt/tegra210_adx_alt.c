...
static struct snd_soc_component_driver tegra210_adx_component = {
...
static int tegra210_adx_platform_probe(struct platform_device *pdev)
{
	...
	ret = snd_soc_register_component(&pdev->dev, &tegra210_adx_component,
				     tegra210_adx_dais,
